...
class TasksDAO {
  ...
  static async deleteTask(id, projectId, userId) {
    try {
      ...
      return { error: `Error occurred while deleting task, ${e}.` };
    }
  }

  static async deleteTasksByProjectId(projectId, userId) {
    try {
      ...
      return {
        error: `Error occurred while deleting tasks related to project, ${e}.`,
      };
    }
  }
