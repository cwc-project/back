// const SessionsDAO = require('./draft.sessionsDAO');
...
class UsersDAO {
  ...
  //   try {
  //     const { value } = await SessionsDAO.addSession(email, jwt);

  //     return { jwt: value.jwt };
  //   } catch (e) {
  ...
  //   try {
  //     return await SessionsDAO.deleteSession(email);
  //   } catch (e) {
